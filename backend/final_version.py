...
def train():
    ...
    GENRES_PATH = os.path.join(BASE_DIR, 'IMDb Movie Genre Classification', 'movies_genres.csv')
    OVERVIEW_PATH = os.path.join(BASE_DIR, 'IMDb Movie Genre Classification', 'movies_overview.csv')
    ...
    print("Model training is complete. Now saving model weights...")
